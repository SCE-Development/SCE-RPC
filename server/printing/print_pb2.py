...
_PRINTREQUEST_OPTIONSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="PrintRequest.OptionsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="PrintRequest.OptionsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_PRINTREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="destination",
            full_name="PrintRequest.destination",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="options",
            full_name="PrintRequest.options",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="encoded_file",
            full_name="PrintRequest.encoded_file",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
...
_PRINTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="PrintResponse.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_HEALTHCHECKUPREQUEST = _descriptor.Descriptor(
    name="HealthCheckUpRequest",
    full_name="HealthCheckUpRequest",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="member_name",
            full_name="HealthCheckUpRequest.member_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PRINTERHEALTHSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="PrinterHealthStatus.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name["HealthCheckUpRequest"] = _HEALTHCHECKUPREQUEST
DESCRIPTOR.message_types_by_name["PrinterHealthStatus"] = _PRINTERHEALTHSTATUS
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

PrintRequest = _reflection.GeneratedProtocolMessageType(
    "PrintRequest",
    (_message.Message,),
    {
...
PrintResponse = _reflection.GeneratedProtocolMessageType(
    "PrintResponse",
    (_message.Message,),
    {
...
HealthCheckUpRequest = _reflection.GeneratedProtocolMessageType(
    "HealthCheckUpRequest",
    (_message.Message,),
    {
        "DESCRIPTOR": _HEALTHCHECKUPREQUEST,
        "__module__": "print_pb2"
        # @@protoc_insertion_point(class_scope:HealthCheckUpRequest)
    },
)
_sym_db.RegisterMessage(HealthCheckUpRequest)

PrinterHealthStatus = _reflection.GeneratedProtocolMessageType(
    "PrinterHealthStatus",
    (_message.Message,),
    {
...
_PRINTER = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            index=1,
            containing_service=None,
            input_type=_HEALTHCHECKUPREQUEST,
