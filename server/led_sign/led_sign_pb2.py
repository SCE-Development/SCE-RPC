...
_LEDSIGNMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="LedSignMessage.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_LEDSIGNRECORD = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="scroll_speed",
            full_name="LedSignRecord.scroll_speed",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="LedSignRecord.background_color",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="text_color",
            full_name="LedSignRecord.text_color",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="border_color",
            full_name="LedSignRecord.border_color",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="LedSignRecord.message",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
...
LedSignMessage = _reflection.GeneratedProtocolMessageType(
    "LedSignMessage",
    (_message.Message,),
    {
...
LedSignRecord = _reflection.GeneratedProtocolMessageType(
    "LedSignRecord",
    (_message.Message,),
    {
