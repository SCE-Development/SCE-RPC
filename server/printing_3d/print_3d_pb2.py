...
_PRINT3DREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="member_name",
            full_name="Print3dRequest.member_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="print_volume_cubic_cm",
            full_name="Print3dRequest.print_volume_cubic_cm",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="copies",
            full_name="Print3dRequest.copies",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="encoded_file",
            full_name="Print3dRequest.encoded_file",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
...
_PRINT3DRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="Print3dResponse.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
Print3dRequest = _reflection.GeneratedProtocolMessageType(
    "Print3dRequest",
    (_message.Message,),
    {
...
Print3dResponse = _reflection.GeneratedProtocolMessageType(
    "Print3dResponse",
    (_message.Message,),
    {
